...
void VCoreMS::_initial__TOP__1(VCoreMS__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->CoreMS__DOT__WF_JUMP_TARGET = 0U;
    vlTOPp->CoreMS__DOT__WF_BRANCH_TARGET = 0U;
...
VL_INLINE_OPT void VCoreMS::_sequent__TOP__2(VCoreMS__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->CoreMS__DOT__WF_BRANCH_TARGET = ((IData)(vlTOPp->RESET)
                                              ? 0U : vlTOPp->CoreMS__DOT__JUMP_BRANCH_TARGET);
    vlTOPp->CoreMS__DOT__WF_JUMP_TARGET = ((IData)(vlTOPp->RESET)
                                            ? 0U : vlTOPp->CoreMS__DOT__EM_JUMP_BRANCH_TARGET);
...
void VCoreMS::_ctor_var_reset() {
    ...
    CoreMS__DOT__WF_JUMP_TARGET = VL_RAND_RESET_I(32);
    CoreMS__DOT__WF_BRANCH_TARGET = VL_RAND_RESET_I(32);
