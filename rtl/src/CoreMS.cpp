...
// 			CTRL_SIG = bitset<17>(topMS->CoreMS__DOT__ControlMS__DOT__CTRL_SIG).to_string();
// 			if (CTRL_SIG[16] == '1'){
// 				printCounter ++;
// 			}
...
// 				// out << showbase << hex << (topMS->CoreMS__DOT__mw_pcPlusFourReg+ 0x10050) << endl;
// 				// printf("IRReg := %08x \t ", topMS->CoreMS__DOT__mw_rdReg);
// 				// printf("PCReg := %08x \t ", (topMS->CoreMS__DOT__mw_pcPlusFourReg+ 0x10050));
// 				// printf("Count := %08x \t ", ++printCounter);
// 				// printf("ALUout:= %08x \t ", topMS->CoreMS__DOT__mw_aluoutReg);
// 				// printf("Rdata := %08x \t ", topMS->CoreMS__DOT__dcache_io_rdata);
// 				// printf("wrtDa := %08x \t ", topMS->CoreMS__DOT__registerFile_io_wdata);

// 				// printf("\nregWrt\tmem2R \twrtSrc\n");
// 				// printf("%d \t ", topMS->CoreMS__DOT__mw_CtrlSigReg_CSregWrite);
// 				// printf("%d \t ", topMS->CoreMS__DOT__mw_CtrlSigReg_CSmem2Reg);
// 				// printf("%d \t ", topMS->CoreMS__DOT__mw_CtrlSigReg_CSwrtSrc);

// 				// printf("\nMemory Address %08x\t%08x\t%08x", topMS->CoreMS__DOT__dcache__DOT__mem[0x3FFFD6],
// 				// 											topMS->CoreMS__DOT__dcache__DOT__mem[0x3FFFD7],
// 				// 											topMS->CoreMS__DOT__dcache__DOT__mem[0x3FFFD8]	 );
// 				// CTRL_SIG = bitset<17>(topMS->CoreMS__DOT__Control__DOT__control_sig).to_string();
				
// 				printf ("PC: %08x \n", topMS->CoreMS__DOT__FD_PC + 0x10054);
// 				//fprintf (out, "PC: %08x \n", topMS->CoreMS__DOT__PC);
// 				printf ("Instruction %d: %08x \n" , int(counter/2), topMS->CoreMS__DOT__FD_IR);
// 				//fprintf (out, "Instruction %d: %08x \n" , int(counter/2), topMS->CoreMS__DOT__INSTRUCTION);
...
// 				printf("Reg01(ra) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[0]);
// 				printf("Reg02(sp) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[1]);
// 				printf("Reg03(gp) := %08x \n", topMS->CoreMS__DOT__RegFile__DOT__REG[2]);
// 				printf("Reg04(tp) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[3]);
// 				printf("Reg05(t0) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[4]);
// 				printf("Reg06(t1) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[5]);
// 				printf("Reg07(t2) := %08x \n", topMS->CoreMS__DOT__RegFile__DOT__REG[6]);
// 				printf("Reg08(s0) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[7]);
// 				printf("Reg09(s1) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[8]);
// 				printf("Reg10(a0) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[9]);
// 				printf("Reg11(a1) := %08x \n", topMS->CoreMS__DOT__RegFile__DOT__REG[10]);
// 				printf("Reg12(a2) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[11]);
// 				printf("Reg13(a3) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[12]);
// 				printf("Reg14(a4) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[13]);
// 				printf("Reg15(a5) := %08x \n", topMS->CoreMS__DOT__RegFile__DOT__REG[14]);
// 				printf("Reg16(a6) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[15]);
// 				printf("Reg17(a7) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[16]);
// 				printf("Reg18(s2) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[17]);
// 				printf("Reg19(s3) := %08x \n", topMS->CoreMS__DOT__RegFile__DOT__REG[18]);
// 				printf("Reg20(s4) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[19]);
// 				printf("Reg21(s5) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[20]);
// 				printf("Reg22(s6) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[21]);
// 				printf("Reg23(s7) := %08x \n", topMS->CoreMS__DOT__RegFile__DOT__REG[22]);
// 				printf("Reg24(s8) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[23]);
// 				printf("Reg25(s9) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[24]);
// 				printf("Reg26(sA) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[25]);
// 				printf("Reg27(sB) := %08x \n", topMS->CoreMS__DOT__RegFile__DOT__REG[26]);
// 				printf("Reg28(t3) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[27]);
// 				printf("Reg29(t4) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[28]);
// 				printf("Reg30(t5) := %08x \t", topMS->CoreMS__DOT__RegFile__DOT__REG[29]);
// 				printf("Reg31(t6) := %08x \n", topMS->CoreMS__DOT__RegFile__DOT__REG[30]);
...
int main(int argc, char **argv, char **env)
{
	...
	while (!Verilated::gotFinish())
	{
		...
		if(clock == 1){
			...
			fd_IRReg = bitset<32>(top->CoreMS__DOT__fd_IRReg ).to_string();
