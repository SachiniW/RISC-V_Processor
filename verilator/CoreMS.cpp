	...
	while (!Verilated::gotFinish())
	{
		...
		if(clock == 1){
			...
			// if (top->Core__DOT__mw_CtrlSigReg_CSregWrite){
				...
				// 											top->Core__DOT__dcache__DOT__mem[0x3FFFD7],
				// 											top->Core__DOT__dcache__DOT__mem[0x3FFFD8]	 );
				CTRL_SIG = bitset<17>(top->CoreMS__DOT__ControlMS__DOT__CTRL_SIG).to_string();
				
				printf ("PC: %08x \n", top->CoreMS__DOT__FD_PC);
				printf ("Instruction %d: %08x \n" , int(counter/2), top->CoreMS__DOT__FD_IR);
				cout << "CS_STALL    : "   <<  CTRL_SIG[17] << endl;
				cout << "CS_TYPE     : "   <<  CTRL_SIG[16,14] << endl;
				cout << "CS_JUMP     : "   <<  CTRL_SIG[13]    << endl;
				cout << "CS_JUMPR    : "   <<  CTRL_SIG[12]    << endl;
				cout << "CS_BRANCH   : "   <<  CTRL_SIG[11]    << endl;
				cout << "CS_ALUOP    : "   <<  CTRL_SIG[10,7]  << endl;
				cout << "CS_ALUSRC1  : "   <<  CTRL_SIG[6]     << endl;
				cout << "CS_ALUSRC2  : "   <<  CTRL_SIG[5]     << endl;
				cout << "CS_MEMRD    : "   <<  CTRL_SIG[4]     << endl;
				cout << "CS_MEMWRT   : "   <<  CTRL_SIG[3]     << endl;
				cout << "CS_M2R      : "   <<  CTRL_SIG[2]     << endl;
				cout << "CS_WRTSRC   : "   <<  CTRL_SIG[1]     << endl;
				cout << "CS_REGWRT   : "   <<  CTRL_SIG[0]     << endl;
